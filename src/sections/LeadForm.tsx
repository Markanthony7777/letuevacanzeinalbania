  ...
  return (
    <section id="contact" className="relative py-16 px-4">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: 'url(/assets/images/Kamaybeachksamil.jpeg)',
      ...
      <div className="container mx-auto max-w-lg relative z-10">
        ...
        <div className="bg-gradient-to-br from-[#1A2A3A] to-[#2A3A4A] rounded-xl shadow-2xl overflow-hidden border border-[#3DB4C0]/20">
            ...
            <div className="flex justify-between">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex flex-col items-center">
                  ...
                  <div className={`text-xs ${step >= i ? 'text-[#3DB4C0]' : 'text-white/70'}`}>
            ...
            {step === 2 && (
              <div className="space-y-4">
                <div>
                  ...
                  >
                    <option value="" className="bg-[#1A2A3A]">Choose a service</option>
                    {services.map((service, index) => (
                      <option key={index} value={service} className="bg-[#1A2A3A]">{service}</option>
                    ))}
                  </select>
                </div>
